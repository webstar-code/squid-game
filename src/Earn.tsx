  ...
  >
    <div className="flex items-center">
      ...
      <div className="text-white">
        ...
        <div className="text-[#FF046B]">+{reward}</div>
      </div>
    </div>
  ...
  return (
    <div className="w-full bg-gradient-to-b from-[#05080D] to-[#1c1c1c] text-white h-screen font-bold flex flex-col max-w-xl">
      ...
      <div className="flex flex-col items-center justify-center mt-6">
        ...
        <h1 className="text-xl font-lemon text-[#FF046B]">Earn more coins</h1>
      </div>
      ...
      <div className="p-4 overflow-y-auto scrollbar scrollbar-thumb-[#51C4C8] scrollbar-track-[#1c1c1c]">
        ...
        <div className="mb-6">
          ...
          <TaskItem
            ...
            reward={500}
            link="https://www.youtube.com/@MemeLordClub"
            completed={!!taskComplete["YouTube"]}
            onClick={() =>
              handleTaskClick(
                "YouTube",
                "https://www.youtube.com/@MemeLordClub",
                "youtube",
                500
              )
            }
        ...
        <div>
          ...
          <TaskItem
            ...
            reward={500}
            link="https://www.tiktok.com/@memelordclub"
            completed={!!taskComplete["TikTok"]}
            onClick={() =>
              handleTaskClick(
                "TikTok",
                "https://www.tiktok.com/@memelordclub",
                "tiktok",
                500
              )
            }
          ...
          <TaskItem
            ...
            reward={500}
            link="https://www.instagram.com/memelordclub"
            completed={!!taskComplete["Instagram"]}
            onClick={() =>
              handleTaskClick(
                "Instagram",
                "https://www.instagram.com/memelordclub",
                "instagram",
                500
              )
            }
          ...
          <TaskItem
            ...
            reward={500}
            link="https://t.me/memelordclubs"
            completed={!!taskComplete["TelegramChannel"]}
            onClick={() =>
              handleTaskClick(
                "TelegramChannel",
                "https://t.me/memelordclubs",
                "telegramChannel",
                500
              )
            }
          ...
          <TaskItem
            ...
            reward={500}
            link="https://t.me/memelordclub"
            completed={!!taskComplete["TelegramGroup"]}
            onClick={() =>
              handleTaskClick(
                "TelegramGroup",
                "https://t.me/memelordclub",
                "telegramGroup",
                500
              )
            }
          ...
          <TaskItem
            ...
            reward={500}
            link="https://x.com/Memelordclub"
            completed={!!taskComplete["X"]}
            onClick={() =>
              handleTaskClick("X", "https://x.com/Memelordclub", "X", 500)
            }
          />
          <TaskItem
            icon={friendsIcon}
