        ...
        <>
          ...
          <div className="relative pt-2 md:pt-14 w-full text-white h-screen font-bold flex flex-col items-center max-w-xl">
            ...
            {activePage === "home" && (
              ...
              //       <div className="p-1 rounded-lg bg-[#FF046B]">
              ...
              //             </p>
              //           </div>
              //           <div className="flex items-center mt-1 border-2 border-[#FF046B] rounded-full">
              //             <div className="w-full h-2 bg-black/70 rounded-full">
              //               <div
              //                 className="bg-gradient-to-r from-[#FF046B] to-[#E4DFDC] h-2 rounded-full"
