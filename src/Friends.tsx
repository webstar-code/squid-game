      ...
      <div className="w-full bg-gradient-to-b from-black to-[#1c1c1c] text-white font-bold flex flex-col max-w-xl shadow-lg shadow-[#EA2E33]/50">
        ...
        <div className="px-4 flex-shrink-0">
          <div className="text-center mt-6">
            <h2 className="text-3xl  font-lemon text-[#FF046B] drop-shadow-lg">
              Invite friends!
            </h2>
          ...
          <div className="mt-6 space-y-4">
            <div className="bg-[#EA2E33]/20 rounded-lg p-4 flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-[#FF046B]">+2,000 for you</p>
              </div>
            </div>
            ...
            <div className="bg-[#EA2E33]/20 rounded-lg p-4 flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-[#FF046B]">+5,000 for you</p>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          <button
            ...
            className="bg-[#FF046B] text-white rounded-full py-3 px-8 flex-1 mr-2"
            style={{
              fontSize: "1.2rem",
              fontWeight: "bold",
              minHeight: "3.5rem",
          ...
          <button
            ...
            className="bg-[#FF046B] text-white rounded-full py-4 px-6 flex-4 ml-2"
            style={{
              fontSize: "1.1rem",
              fontWeight: "bold",
              minHeight: "3.2rem",
